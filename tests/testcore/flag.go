...
func init() {
	...
	flag.StringVar(&cliFlags.persistenceDriver, "persistenceDriver", "sqlite", "driver of nosql/sql - [cassandra, mariadb10, mysql8, postgres12, sqlite]")
...
func UseSQLVisibility() bool {
	...
	case mariadb.PluginName, mysql.PluginName, postgresql.PluginName, postgresql.PluginNamePGX, sqlite.PluginName:
		return true
